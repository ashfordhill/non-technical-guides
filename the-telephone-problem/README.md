...
Abstract a container framework such as Kubernetes/Docker Swarm and connect this abstraction with the dense technical documentation of government-style PDFs loaded with acronyms.
...
Before you can form understanding, you must know what apples, fruits, cats and animals are (on at least some basic level). And if you're trying to explain this concept to another person, they must know all these elements too.

## Use Metaphors! Find Common Ground!

Metaphors and finding common terms to connect what you don't know to what you already know is useful. 
